...
/hx/bitcoind   -testnet -datadir=/hx/bitcoin_data   -rpcuser=a -rpcpassword=b -rpcallowip=192.168.0.0/16 -rpcport=60011 -server  -txindex &
...
/hx/litecoind  -testnet -datadir=/hx/litecoin_data  -rpcuser=a -rpcpassword=b -rpcallowip=192.168.0.0/16 -rpcport=60012 -server  -txindex
