...
/hx/bitcoind   -testnet -datadir=/hx/bitcoin_data -rpcbind=0.0.0.0 -rpcuser=a -rpcpassword=b -rpcallowip=0.0.0.0/0 -rpcport=60011 -server  -txindex &
/hx/omnicore-0.3.1/bin/omnicored -datadir=/hx/omni_data -rpcuser=a -rpcpassword=b -rpcbind=0.0.0.0 -rpcallowip=0.0.0.0/0 -rpcport=60013 -server -txindex &
...
/hx/litecoind  -testnet -datadir=/hx/litecoin_data -rpcuser=a -rpcpassword=b -rpcbind=0.0.0.0 -rpcallowip=0.0.0.0/0 -rpcport=60012 -server  -txindex &
/bin/bash
