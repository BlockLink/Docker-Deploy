...
def start():
    ...
    if not exist:
        filePath1 = '/hx/hcwallet -A "/hx/hc_data/hcwallet_data" -u "a" -P "b" --testnet -c "127.0.0.1:19019" --noclienttls --rpclisten 127.0.0.1:19020 --noservertls --create'
        filePath2 = '/hx/hcwallet -A "/hx/hc_data/hcwallet_data" --pass 12345678 -u "a" -P "b" --testnet -c "127.0.0.1:19019" --noclienttls --rpclisten 127.0.0.1:19020 --noservertls'
